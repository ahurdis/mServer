...
GraphUtilities.getCodeGenerationInput = function (req, res) {
  ...
  try {
    ...
    let temp = JSON.parse(queryObj.jsonData);
    ret = {
      documentName: temp.documentName,
      graph: JSON.parse(JSON.stringify(temp.graph), Serialization.Reviver)
    };
  }
  catch (e) {
    console.dir(e);
