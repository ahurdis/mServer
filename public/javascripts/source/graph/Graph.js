...
define(['javascripts/source/graph/GraphData',
    'javascripts/source/graph/GraphSerialization'], function (GraphData, GraphSerialization) {
        'use strict';
...
//            Math.random().toString(36).substr(2, 16);
        ...
        Graph.fromJSON = function (value) {
            return GraphSerialization.fromJSON(Graph, value);
        };
