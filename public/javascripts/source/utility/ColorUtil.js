...
define([],
    function () {
        ...
        ColorUtil.parseColor = function(input) {
            if (input.substr(0,1)=="#") {
        ...
        ColorUtil.rgbToHex = function (rgb) {
            ...
            var m = ColorUtil.parseColor(rgb);

            if (m) {
                return '#' + ColorUtil.componentToHex(m[0]) +
                ColorUtil.componentToHex(m[1]) +
                ColorUtil.componentToHex(m[2]);
            }
        };
